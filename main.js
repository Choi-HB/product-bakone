const i18n = {
    ko: {
        ...
        "guide-how-list": `<li>원하는 여행지를 리스트에서 선택합니다</li><li>'ウェブカム'をオンにするか'写真をアップ로드'ボタンを押して写真を読み込みます</li><li>AIが自動的に背景を削除し、目的地に合成します</li><li>スライダーを調節してサイズと位置を合わせます</li><li>'写真を保存'を押して思い出を残しましょう</li>`,
    ...
    ja: {
        ...
        "studio-tip": "* 人物写真が鮮明であるほど、背景削除の結果가 좋아집니다.",
