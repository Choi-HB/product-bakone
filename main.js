...
customImage: "https://images.unsplash.com/photo-1528072164453-f4e8ef0d475a?q=80&w=1920&auto=format&fit=crop",
  ...
  { id: "p9", region: "Other", name: { ko: "두바이, UAE", en: "Dubai, UAE", ja: "ドバイ・アラブ首長国連邦", zh: "迪拜，阿联酋" },
...
desc: {
  ...
  { id: "p12", region: "Asia", name: { ko: "발리, 인도네시아", en: "Bali, Indonesia", ja: "バリ・インドネシア", zh: "巴厘岛，印度尼시아" }, 
  ...
  { id: "p13", region: "Europe", name: { ko: "산토리니, 그리스", en: "Santorini, Greece", ja: "サントリーニ・ギリシャ", zh: "圣托里니, 希腊" }, 
...
const extraPlaces = [
  ...
  { id: "p29", region: "America", name: { ko: "퀘벡, 캐나다", en: "Quebec City, Canada", ja: "ケベック・シティ・カナダ", zh: "魁北克市, 加拿大" },     
  ...
  { id: "p39", region: "Europe", name: { ko: "리스본, 포르투갈", en: "Lisbon, Portugal", ja: "リスボン・ポルトガル", zh: "리스본, 葡萄牙" },     
  ...
  { id: "p40", region: "Europe", name: { ko: "프라하, 체코", en: "Prague, Czech Republic", ja: "プラハ・チェコ", zh: "布拉格, 捷크" },     
