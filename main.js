...
const places = [
    { id: "p1", region: "Europe", name: { ko: "파리, 프랑스", en: "Paris, France", ja: "パリ・フランス", zh: "巴黎，法国" }, desc: {
    ...
    { id: "p2", region: "Europe", name: { ko: "런던, 영국", en: "London, UK", ja: "ロンドン・イギリス", zh: "伦敦，英国" }, desc: {
    ...
    { id: "p3", region: "Europe", name: { ko: "로마, 이탈리아", en: "Rome, Italy", ja: "ローマ・イタリア", zh: "罗马，意大利" }, desc: {
    ...
    { id: "p4", region: "Asia", name: { ko: "서울, 대한민국", en: "Seoul, South Korea", ja: "ソウル・韓国", zh: "首尔，韩国" }, desc: {
    ...
    { id: "p5", region: "Asia", name: { ko: "도쿄, 일본", en: "Tokyo, Japan", ja: "東京・日本", zh: "东京，日本" }, desc: {
    ...
    { id: "p6", region: "America", name: { ko: "뉴욕, 미국", en: "New York, USA", ja: "ニューヨーク・米国", zh: "纽约，美国" }, desc: {
    ...
    { id: "p7", region: "Europe", name: { ko: "바르셀로나, 스페인", en: "Barcelona, Spain", ja: "バルセロナ・スペイン", zh: "巴塞罗那，西班牙" }, desc: {
    ...
    { id: "p8", region: "Other", name: { ko: "시드니, 호주", en: "Sydney, Australia", ja: "シドニー・オーストラリア", zh: "悉니，澳大利亚" }, desc: {
    ...
    { id: "p10", region: "Europe", name: { ko: "베네치아, 이탈리아", en: "Venice, Italy", ja: "ヴェネツィア・イタリア", zh: "威尼斯，意大利" }, desc: {
    ...
    { id: "p12", region: "Asia", name: { ko: "발리, 인도네시아", en: "Bali, Indonesia", ja: "バリ・インドネシア", zh: "巴厘岛，印度尼시아" }, 
      customImage: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=1920&auto=format&fit=crop",
      copyright: "© Unsplash / Alec Favale",
      desc: {
    ...
    { id: "p14", region: "America", name: { ko: "마추픽추, 페루", en: "Machu Picchu, Peru", ja: "マチュピチュ・ペ루", zh: "马丘比丘，秘鲁" }, desc: {
    ...
    { id: "p15", region: "Other", name: { ko: "몰디브", en: "Maldives", ja: "モル디브", zh: "马尔代夫" }, 
    ...
    { id: "p16", region: "Other", name: { ko: "페트라, 요르단", en: "Petra, Jordan", ja: "ペトラ・ヨルダン", zh: "佩特拉，约旦" }, desc: {
    ...
    { id: "p17", region: "Other", name: { ko: "카이로, 이집트", en: "Cairo, Egypt", ja: "カイロ・エジプト", zh: "开罗，埃及" }, desc: {
    ...
    { id: "p18", region: "Other", name: { ko: "레이캬비크, 아이슬란드", en: "Reykjavik, Iceland", ja: "レイキャビク・アイスランド", zh: "雷克雅未克，冰岛" }, desc: {
    ...
    { id: "p19", region: "Europe", name: { ko: "취리히, 스위스", en: "Zurich, Switzerland", ja: "チューリッヒ・スイス", zh: "苏黎世，瑞士" }, desc: {
    ...
    { id: "p20", region: "Europe", name: { ko: "스톡홀름, 스웨덴", en: "Stockholm, Sweden", ja: "ストックホルム・スウェーデン", zh: "斯德哥尔摩，瑞典" }, desc: {
    ...
    { id: "p22", region: "Asia", name: { ko: "방콕, 태국", en: "Bangkok, Thailand", ja: "バンコク・タイ", zh: "曼谷，泰国" }, desc: {
    ...
    { id: "p23", region: "Europe", name: { ko: "빈, 오스트리아", en: "Vienna, Austria", ja: "ウィーン・オーストリア", zh: "维也纳，奥地利" }, desc: {
    ...
    { id: "p24", region: "Europe", name: { ko: "부다페스트, 헝가리", en: "Budapest, Hungary", ja: "ブダペ스트・ハンガリー", zh: "布达佩斯，匈牙利" }, desc: {
    ...
    { id: "p25", region: "Asia", name: { ko: "타이베이, 대만", en: "Taipei, Taiwan", ja: "台北・台湾", zh: "台北，台湾" }, desc: {
...
const extraPlaces = [
    ...
    { id: "p29", region: "America", name: { ko: "퀘벡, 캐나다", en: "Quebec City, Canada", ja: "ケベック・シティ・カナ다", zh: "魁北克市，加拿大" } },
    ...
    { id: "p38", region: "Europe", name: { ko: "아테네, 그리스", en: "Athens, Greece", ja: "アテネ・ギリシャ", zh: "雅典，希腊" } },
    ...
    { id: "p46", region: "Asia", name: { ko: "홍콩", en: "Hong Kong", ja: "香港", zh: "香港", 
      customImage: "https://images.unsplash.com/photo-1506351421178-63b52a2d25a2?q=80&w=1920&auto=format&fit=crop",
      copyright: "© Unsplash / Simon Zhu" } },
    ...
    { id: "p49", region: "Asia", name: { ko: "부산, 대한민국", en: "Busan, South Korea", ja: "釜山・韓国", zh: "釜山，韩国",
      customImage: "https://images.unsplash.com/photo-1590059393325-09cdfd109823?q=80&w=1920&auto=format&fit=crop",
      copyright: "© Unsplash / Daniel Bernard" } },
