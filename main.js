...
const places = [
    ...
    { id: "p12", region: "Asia", name: { ko: "발리, 인도네시아", en: "Bali, Indonesia", ja: "バリ・インドネシア", zh: "巴厘岛，印度尼西亚" }, desc: {
    ...
    { id: "p13", region: "Europe", name: { ko: "산토리니, 그리스", en: "Santorini, Greece", ja: "サントリーニ・ギリシャ", zh: "圣托里尼，希腊" }, desc: {
    ...
    { id: "p14", region: "America", name: { ko: "마추픽추, 페루", en: "Machu Picchu, Peru", ja: "マチュピチュ・ペルー", zh: "马丘比丘，秘鲁" }, desc: {
    ...
    { id: "p15", region: "Other", name: { ko: "몰디브", en: "Maldives", ja: "モルディブ", zh: "马尔代夫" }, desc: {
    ...
    { id: "p24", region: "Europe", name: { ko: "부다페스트, 헝가리", en: "Budapest, Hungary", ja: "ブダペスト・ハンガリー", zh: "布达佩斯，匈牙利" }, desc: {
